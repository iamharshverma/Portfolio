                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-7 mb-4 mb-lg-0">
                                ...
                                <div class="d-flex flex-wrap align-items-center">
                                    ...
                                    <a href="https://orcid.org/0000-0003-2134-2600" target="_blank" class="btn font-weight-bold rounded px-3 py-2 mr-2 mb-2 shadow-sm" style="background: #A6CE39; color: #111827; border: 1px solid #91b72e;" title="ORCID Profile: 0000-0003-2134-2600">
                                        <img src="images/profiles/orcid.svg" width="16" height="16" class="mr-1" style="vertical-align: -2px;" alt="ORCID"> ORCID
                                    </a>
                                ...
                                <div class="patent-card">
                                    <div>
                                        ...
                                        <div class="patent-meta">
                                            ...
                                            <span class="ml-2 text-muted">• Patent Application Number: <strong>201711003607</strong></span>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center mt-3 pt-2 border-top">
                                        ...
                                        <button type="button" class="btn-pub-action btn-pub-outline" onclick="copyPatentDetails('SYSTEMS AND METHODS FOR PERFORMING LOAD TESTING OF A SOCIAL NETWORKING APPLICATION', 'Patent No: 555747 · App No: 201711003607', 'Dec 3, 2024', 'Granted')">
