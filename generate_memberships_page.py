        ...
        <div class="container">
            ...
            <div class="filter-nav-wrap" id="filterNavWrap">
                <button class="btn-filter-pill active" data-filter="all">
                    All Memberships <span class="filter-count-badge">19</span>
                </button>
                <button class="btn-filter-pill" data-filter="fellowship">
                    <i class="mdi mdi-medal-outline"></i> Fellowships &amp; Senior <span class="filter-count-badge">6</span>
                </button>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
                <span class="text-muted font-weight-bold" id="resultsCountText">Showing all 19 invited memberships and fellowships</span>
                <div class="dropdown">
            ...
            <div class="row" id="membershipsGrid">
                ...
                <div class="col-lg-4 col-md-6 mb-4 membership-item" data-category="fellowship" data-tier="1" data-search="ieee senior member institute of electrical and electronics engineers ieee computer society 95132014 engineering distributed systems">
                    <div class="membership-card">
                        ...
                        <div class="membership-body">
                            ...
                            <div class="membership-footer">
                                <a href="https://ieee-collabratec.ieee.org/app/p/HarshVerma59" target="_blank" rel="noopener noreferrer" class="btn-verify" title="IEEE Collabratec® Public Profile">
                                    <i class="mdi mdi-shield-check"></i> IEEE Collabratec® Public Profile
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <!-- 8. Science Tech Xplore Fellow Member -->
                <div class="col-lg-4 col-md-6 mb-4 membership-item" data-category="fellowship" data-tier="1" data-search="science tech xplore sciencetechxplore fellow member harsh verma scientific research digital humanity computing technology fellow-members1.php innovating digital humanity">
                    <div class="membership-card">
                        <div class="membership-header-badge">
                            <span class="membership-tier-pill tier-fellow">Fellow Member</span>
                            <img src="images/memberships/sciencetechxplore.svg" alt="Science Tech Xplore Fellow Member Logo">
                        </div>
                        <div class="membership-body">
                            <h3 class="membership-title">Science Tech Xplore</h3>
                            <div class="membership-org"><i class="mdi mdi-medal text-warning mr-1"></i> Fellow Member</div>
                            <div class="membership-credential-id"><i class="mdi mdi-certificate-outline mr-1"></i> Official Registry: Harsh Verma</div>
                            <p class="membership-desc">
                                Honored as an elected Fellow Member of Science Tech Xplore, recognizing distinguished research contributions, scientific innovation, and engineering leadership in advancing digital humanity and artificial intelligence architectures.
                            </p>
                            <div class="membership-tags">
                                <span class="membership-tag">#FellowMember</span>
                                <span class="membership-tag">#ScienceTechXplore</span>
                                <span class="membership-tag">#DigitalHumanity</span>
                                <span class="membership-tag">#ScientificResearch</span>
                            </div>
                            <div class="membership-footer">
                                <a href="https://sciencetechxplore.org/fellow-members1.php" target="_blank" class="btn-verify">
                                    <i class="mdi mdi-shield-check"></i> Verify Fellow Membership
                                </a>
                            </div>
                        </div>
                    </div>
    ...
    function applyFilters() {
        ...
        if (resultsCountText) {
            if (query) {
                ...
                resultsCountText.innerText = `Showing all 19 invited memberships and fellowships`;
            }
        }
    }
